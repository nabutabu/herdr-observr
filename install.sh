#!/bin/sh
#
# One-liner installer / upgrader for herdr-observr. Detects the host OS and
# architecture, downloads the matching archive from the latest GitHub Release,
# extracts the static `herdr-observr` binary, and drops it into ~/.local/bin
...
#
#   curl -fsSL .../install.sh | VERSION=v0.0.3 sh
#
